...
import { SignatureEventTarget } from './signature-event-target';
...
export class SignaturePad extends SignatureEventTarget {
  // Public stuff
  ...
  constructor(
    ...
    private readonly onChange?: (str: string) => void,
    options: Options = {},
  ) {
    super();
